...
image::images/github-interface.png[GitHub repository interface,80%]



*GitLab* launched in 2011 as an open source platform and it remains fully open source. Users can import their GitHub repositories into GitLab and vice versa.


image::images/gitlab-interface.png[GitLab repository interface,81%]
